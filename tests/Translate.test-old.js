...
describe('<Translate />', () => {
  ...
  it.done(
    "should add <Translate>'s children to translations when default language is set",
    () => {
      const Translate = getTranslateWithContext({
        ...initialState,
        languages: []
      ...
      const wrapper = mount(
        <Translate id="no_translation">Default Translation</Translate>
      );
  ...
  it.done(
    "should add <Translate>'s children to translations under options.defaultLanguage for id",
    () => {
      const Translate = getTranslateWithContext();
      const wrapper = mount(
  ...
  it.done(
    'should not override default language translation if no children provided',
    () => {
      const Translate = getTranslateWithContext();
  ...
  it.done(
    'should not add default language translation if ignoreTranslateChildren = true',
    () => {
      const Translate = getTranslateWithContext();
      const wrapper = mount(
  ...
  it.done(
    'should not add default language translation if ignoreTranslateChildren = true in context',
    () => {
      const Translate = getTranslateWithContext({
        ...initialState,
        options: {
